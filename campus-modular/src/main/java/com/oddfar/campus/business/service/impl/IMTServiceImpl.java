...
//        }
        //日志记录
        IMTLogFactory.reservation(iUser, logContent, "申购");
        //预约后延迟领取耐力值
    ...
    public void getEnergyAwardDelay(IUser iUser) {
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                //日志记录
                IMTLogFactory.reservation(iUser, logContent, "耐力值");
            }
        };
...
//            e.printStackTrace();
        ...
        //日志记录
        IMTLogFactory.reservation(iUser, logContent, "旅行");
    }
            ...
            try {
                ...
                for (Object itemVO : itemVOs) {
                    ...
                    if (item.getInteger("status") == 2 && DateUtil.between(item.getDate("reservationTime"), new Date(), DateUnit.HOUR) < 24) {
                        ...
                        IMTLogFactory.reservation(iUser, logContent, "成功");
                    }
                }
            } catch (Exception e) {
